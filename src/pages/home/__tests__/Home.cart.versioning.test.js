...
import { getProductCell, increaseProduct } from 'pages/helpers'
...
describe('Home - Cart - Versioning', () => {
  ...
  it('should add a product listening the backend response', async () => {
    const responses = [
      { path: '/customers/1/home/', responseBody: homeWithGrid },
      {
        ...
        responseBody: {
          ...
          version: 1,
          lines: [
            { product: productBase, version: 1, quantity: 1, sources: [] },
          ],
        },
      },
      {
        ...
        responseBody: {
          ...
          version: 2,
          lines: [
            { product: productBase, version: 2, quantity: 55, sources: [] },
          ],
        },
      },
    ]
  ...
  it('should add a product listening the backend response with a cart without version', async () => {
    const responses = [
      { path: '/customers/1/home/', responseBody: homeWithGrid },
      {
        path: '/customers/1/cart/',
  ...
  it('should only listen to the last backend response increasing products', async () => {
    ...
    const responses = [
      ...
      },
      {
        ...
        requestBody: {
          id: '5529dc8b-0a94-4ae0-8145-de5186b542c6',
          version: 1,
          lines: [{ quantity: 3, product_id: '8731', sources: ['+NA', '+NA'] }],
        },
        responseBody: {
          id: '5529dc8b-0a94-4ae0-8145-de5186b542c6',
          version: 4,
    ...
    expect(productCell).toHaveTextContent('3 units')
