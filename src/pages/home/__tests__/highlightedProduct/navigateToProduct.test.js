...
import { clickOnHighlightedBanner } from '../helpers'
...
it('should show the product page when the user clicks on the banner', async () => {
  ...
  expect(Tracker.sendInteraction).toHaveBeenCalledWith('home_section_click', {
    ...
    home_section_type: 'product_highlighted',
  })
})
