...
interface OrderDisruptedByCustomerStatusProps {
  order: Order
}

export const OrderDisruptedByCustomerStatus = ({
  order,
}: OrderDisruptedByCustomerStatusProps) => {
      ...
      <div className="order-status__content">
        ...
        >
          <span className="order-status__content-body-message">
            {t('order.detail.status.disrupted_by_customer.body')}
          </span>
        </p>
      </div>
    </div>
